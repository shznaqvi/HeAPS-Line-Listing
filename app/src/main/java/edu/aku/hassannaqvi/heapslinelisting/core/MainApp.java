...
import static edu.aku.hassannaqvi.heapslinelisting.database.DatabaseHelper.DATABASE_PASSWORD;
...
import edu.aku.hassannaqvi.heapslinelisting.ui.LoginActivity;
import edu.aku.hassannaqvi.heapslinelisting.ui.PeriodicWorkerHelper;


public class MainApp extends Application implements LifecycleObserver {

    public static final String PROJECT_NAME = "heapslinelisting";
    ...
    public static final String _UPDATE_URL = MainApp._IP + "/heapslinelisting/app/";
    ...
    public static ArraySet<Streets> streetList;
