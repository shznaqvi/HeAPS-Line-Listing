...
import static edu.aku.hassannaqvi.heapslinelisting.core.MainApp.uploadData;
...
import edu.aku.hassannaqvi.heapslinelisting.adapters.SyncListAdapter;
...
import edu.aku.hassannaqvi.heapslinelisting.models.SyncModel;
import edu.aku.hassannaqvi.heapslinelisting.workers.DataDownWorkerALL;
import edu.aku.hassannaqvi.heapslinelisting.workers.DataUpWorkerALL;
import edu.aku.hassannaqvi.heapslinelisting.workers.PhotoUploadWorker2;
    ...
    public void ProcessStart(View view) {
        ...
        if (viewId == R.id.btnUpload) {
            ...
            if (bi.uploadUnlocked.isChecked()) {
                // Forms - unlocked
                uploadTables.add(new SyncModel(ListingTable.TABLE_NAME, true));
                try {
